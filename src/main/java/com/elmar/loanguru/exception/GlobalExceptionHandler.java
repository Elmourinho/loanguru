...
import com.elmar.loanguru.constants.HttpResponseConstants;
import com.elmar.loanguru.error.ConstraintsViolationError;
...
public class GlobalExceptionHandler extends DefaultErrorAttributes {
	...
	public ResponseEntity<Map<String, Object>> handle(LoanException ex, WebRequest request) {
	...
	protected ResponseEntity<Map<String, Object>> ofType(WebRequest request,
			HttpStatus status, LoanException ex) {
